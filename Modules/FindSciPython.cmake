...
#
# $Id: FindSciPython.cmake 852 2015-07-15 16:11:49Z jrobcary $
#
...
# Shared library
  message(STATUS "Looking for ${Python_LIBRARY_NAMES} under ${Python_ROOT_DIR} with subdirs, lib/python${Python_MAJMIN}/config lib Libs.")
  find_library(Python_LIBRARY
    NAMES ${Python_LIBRARY_NAMES}
    PATHS ${Python_ROOT_DIR}
    PATH_SUFFIXES lib/python${Python_MAJMIN}/config lib Libs
    NO_DEFAULT_PATH
  )
  SciPrintVar(Python_LIBRARY)

  if (Python_LIBRARY)
# getfilename_component is not working here
    # SciPrintVar(Python_LIBRARY)
...
# Static library
  find_library(Python_STLIBS
    NAMES lib${Python_LIBRARY_NAMES}.a ${Python_LIBRARY_NAMES}.lib
    PATHS ${Python_ROOT_DIR}
...
foreach (var ROOT_DIR BINDIR EXE NAME NAME_WE MAJMIN
    INCLUDE_DIRS
    LIBRARY LIBRARY_NAME LIBRARIES LIBRARY_DIRS STLIBS STLIB_DIRS DLLS LIBS
    MODULES_DIR MODULES_SUBDIR SITE)
  SciPrintVar(Python_${var})
endforeach ()
